...
export default function () {
  return (
    ...
    <div className='flex flex-col overflow-auto border-3 border-gray-700 p-5 rounded-lg shadow-lg h-110 w-100 shadow-[0_0_20px_rgba(250,250,250,0.3)] hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]'>
