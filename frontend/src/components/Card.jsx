...
export default function () {
  return (
    ...
    <div className='flex flex-col overflow-auto border-2 border-gray-700 p-5 rounded-lg shadow-lg h-120 w-100 shadow-[0_0_15px_rgba(250,250,250,0.3)] hover:shadow-[0_0_15px_rgba(255,255,255,0.3)]'>
        ...
        <p className='mb-3'>A IoT project, also our major project - prototype of a device that helps Alzheimer patients more independent, uses ESP32 microcontroller, AI models for face recognition, scream detection and MERN website</p>
        <div className='flex flex-row gap-3'>
            <Word word={"MERN stack"}/>
            <Word word={"Iot"}/>
            <Word word={"AI models"}/>
        </div>
